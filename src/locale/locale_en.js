var locale = () => (
    {
        pages: {
            ...
            sales_invoice_list: 'SALES INVOICES',
            sales_invoice_form: 'SALES INVOICE',
            purchase_invoice_list: 'PURCHASING INVOICES',
            purchase_invoice_form: 'PURCHASING INVOICE',
            all_invoice_list: 'ALL INVOICES',
        ...
        payment_status: [
            ...
            { code: 'WAITING', description: 'WAITING'},
            { code: 'DELAYED', description: 'DELAYED'}
        ],        
        fields: {
            username: {
                title: 'E-Mail',
        ...
        messages: {
            ...
            tablefooter_nof_recs: 'Total {0} items',
            atmostonenewrecord: 'There can be at most one new record',
            register_message:"Don't have an account yet? Become a member to benefit from our special services to our members."
        },
        formats: {
            date: 'dd-mm-yyyy',
        }
