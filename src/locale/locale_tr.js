var locale = () => (
    {
        pages: {
            ...
            sales_invoice_list: 'SATIŞ FATURALARI',
            sales_invoice_form: 'SATIŞ FATURASI',
            purchase_invoice_list: 'ALIŞ FATURALARI',
            purchase_invoice_form: 'ALIŞ FATURASI',
            all_invoice_list: 'TÜM FATURALAR',
        ...
        payment_status: [
            { code: 'PAID', description: 'Ödendi' },
            { code: 'WAITING', description: 'Bekliyor'},
            { code: 'DELAYED', description: 'Gecikmiş'}
        ],
        fields: {
            username: {
                title: 'E-Posta',
        ...
        buttons: {
            ...
            registeruser: 'Üyelik Oluştur',
            loginuserprofile: 'Üyelik Bilgilerim',
        },
        invoice: {
            total: 'Toplam',
            vat: 'KDV',
        ...
        messages: {
            ...
            tablefooter_nof_recs: 'Toplam {0} kayıt',
            atmostonenewrecord: 'En fazla bir tane yeni kayıt olabilir!',
            register_message: `Henüz Üye Değil Misiniz? Üyelerimize özel hizmetlerimizden faydalanabilmek için üye olun.`
        },
        formats: {
            date: 'dd.mm.yyyy',
